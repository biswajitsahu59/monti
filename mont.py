...
# -------------------- RESTAURANT --------------------
    ...
    cols = st.columns(3)
    cols[0].image(r"C:\Users\sbiswaji\Downloads\Food.jpg", width=250)
    cols[1].image(r"C:\Users\sbiswaji\Downloads\food2.jpg", width=250)
    cols[2].image(r"C:\Users\sbiswaji\Downloads\restpic1.jpg",width=250)
